...
const NavLink = ({ item, isActive, isMobile = false, onClick = () => {} }: { item: NavItem; isActive: boolean; isMobile?: boolean; onClick?: () => void }) => (
  <Link
    ...
    className={`
      ...
      ${isActive ? 'text-blue-600 bg-blue-50 bg-opacity-50' : 'text-black hover:text-blue-600'}
...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-transparent backdrop-blur-md shadow-md">
